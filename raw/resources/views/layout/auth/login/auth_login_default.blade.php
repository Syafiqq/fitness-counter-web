...
@section('body-content')
    ...
    {!! nl2br(PHP_EOL) !!}
    {!! $form->email('email', 'mohammadsyahronimeizu@gmail.com', ['placeholder' => 'Email', 'required'=> true]) !!}
    {!! nl2br(PHP_EOL) !!}
    {!! $form->input('password', 'password', '3514140405940002', ['value' => 'password','placeholder' => 'Password', 'required'=> true]) !!}
    {!! nl2br(PHP_EOL) !!}
