...
@section('head-css-post')
    @parent
    <link rel="stylesheet" href="{{asset('/css/layout/admin/dashboard/home/admin_dashboard_home_default.min.css')}}">
@endsection

@section('body-js-lower-post')
    @parent
    <script type="text/javascript" src="{{asset('/js/layout/admin/dashboard/home/admin_dashboard_home_default.min.js')}}"></script>
@endsection
