...
@section('head-css-post')
    @parent
    <link rel="stylesheet" href="{{asset('/css/layout/admin/event/management/tester/admin_event_management_tester_bulma.min.css')}}">
@endsection

@section('body-js-lower-post')
    @parent
    <script type="text/javascript" src="{{asset('/js/layout/admin/event/management/tester/admin_event_management_tester_bulma.min.js')}}"></script>
@endsection
